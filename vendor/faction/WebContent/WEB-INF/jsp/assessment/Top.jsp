...
<div class="col-md-12">
 <div class="nav-tabs-custom">
   <ul class="nav nav-tabs" role="tablist">
     ...
     <li class="nav-item active" role="presentation"><a href="#Summary" data-toggle="tab" role="tab">概要</a></li>
     <jsp:include page="AssessmentExtendedTabs.jsp"/>
     <li class="nav-item "><a href="VulnerabilityView#VulnView">脆弱性</a></li>
     <li class="nav-item "><a href="VulnerabilityView#NoteView">ノート</a></li>
     <li class="nav-item "><a href="CheckList">チェックリスト</a></li>
     <li class="nav-item "><a href="#Finalize" data-toggle="tab"  > 完了処理</a></li>
     <li class="nav-item "><a href="#History" data-toggle="tab"  >履歴</a></li>
     <li class="nav-item " ><a href="AuditLog" >監査</a></li>
    
   	</s:if>
   	<s:if test="%{#request.vulnsActive == 'true'}">
     <li class="nav-item " role="presentation"><a href="Assessment#Summary" role="tab">概要</a></li>
     <jsp:include page="AssessmentExtendedTabs.jsp"/>
     <li class="nav-item "><a href="#VulnView" data-toggle="tab" >脆弱性</a></li>
     <li class="nav-item "><a href="#NoteView" data-toggle="tab" >ノート</a></li>
     <li class="nav-item "><a href="CheckList">チェックリスト</a></li>
     <li class="nav-item "><a href="Assessment#Finalize">完了処理</a></li>
     <li class="nav-item "><a href="Assessment#History">履歴</a></li>
     <li class="nav-item " ><a href="AuditLog" >監査</a></li>
    </s:if>
    <s:if test="%{#request.vulnsActive != 'true' && #request.summaryActive != 'true' }">
     ...
     <li class="nav-item "><a href="VulnerabilityView#VulnView">脆弱性</a></li>
     <li class="nav-item "><a href="VulnerabilityView#NoteView">ノート</a></li>
     <li class="nav-item <s:if test="%{#request.checklistActive == 'true'}">active</s:if>"><a href="CheckList">チェックリスト</a></li>
     <li class="nav-item "><a href="Assessment#Finalize">完了処理</a></li>
     <li class="nav-item "><a href="Assessment#History">履歴</a></li>
     <li class="nav-item <s:if test="%{#request.auditActive == 'true'}">active</s:if>" ><a href="AuditLog" >監査</a></li>
    </s:if>
   </ul>
