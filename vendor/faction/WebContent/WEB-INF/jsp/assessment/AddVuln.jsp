		...
		<bs:row>
			<bs:mco colsize="2">
				<button id="addVuln" class="btn btn-primary btn-lg"
					...
					<b><i class="glyphicon glyphicon-plus"></i> 新規脆弱性</b>
				</button>
			</bs:mco>
		</bs:row>
		<bs:row>
					...
					<div class="form-horizontal">
						<bs:mco colsize="6">
							<bs:row>
								<div class="form-group">
									<input type="hidden" id="dvulnerability" /> <label for="title"
										class="col-sm-2 control-label">題名: <span
										id="title_header"></span></label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="title"
											placeholder="脆弱性名、CVE idを入力して検索。改行で任意の名前を設定。">
									</div>
								</div>
							</bs:row>
							<bs:row>
								<div class="form-group">
									<label for="category" class="col-sm-2 control-label">分類:
							...
							<s:if test="sectionsEnabled">
								<bs:row>
									<div class="form-group">
										<label for="section" class="col-sm-2 control-label">章:
						...
						<bs:mco colsize="6">
							<div class="cvss<s:property value="!(assessment.type.cvss31||assessment.type.cvss40)"/>">
								<bs:row>
									<div class="form-group">
										<label for="title" class="col-sm-4 control-label">深刻
											度: <span id="overall_header"></span>
										</label>
										<div class="col-sm-4">
								...
								<bs:row>
									<div class="form-group">
										<label for="title" class="col-sm-4 control-label">影響:
								...
								<bs:row>
									<div class="form-group">
										<label for="title" class="col-sm-4 control-label">想定事象:
							...
							<div class="form-group col-md-3" style="padding-left: 25px">
								<label class=""
									title='Variable: &#x24;{cf<s:property value="variable"/>}'><s:property value="key"/>
										<span id="type${id}_header"></span><br/><small>変数名: &#x24;&#x7B;cf<s:property value="variable"/>&#x7D;</small>
										</label>
									<div class="" style="height: 50px">
										...
										<s:if test="fieldType == 1">
											<input type="checkbox" class="icheckbox_minimal-blue"
												...
												<s:if test="defaultValue == 'true'">確認済</s:if>
												<s:if test="assessment.InPr || assessment.prComplete || assessment.finalized || readonly">disabled</s:if> />
										</s:if>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-default">
								<div class="box-header">
									<h3 class="box-title">
										<i class="glyphicon glyphicon-edit"></i> 脆弱性
										概要: <span id="description_header"></span>
									</h3>
								</div>
								<!-- /.box-header -->
						...
						<div class="col-md-12">
							<div class="box box-info">
								<div class="box-header">
									<h3 class="box-title">
										<i class="glyphicon glyphicon-edit"></i> 脆弱性
										推奨事項: <span id="recommendation_header"></span>
									</h3>
								</div>
								<!-- /.box-header -->
								<div class="box-body pad">
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-info">
								<div class="box-header">
									<h3 class="box-title">
										<i class="glyphicon glyphicon-edit"></i> 詳細: <span
							...
							<tr data-vulnid="${id}">
								...
								<td><span class="vulnControl vulnControl-delete"
									...
									<s:if test="hideit">disabled</s:if>><i
										class="fa fa-trash" title="脆弱性を削除"></i></span></td>
							</tr>
						</s:iterator>
					</tbody>
					<tfoot>
