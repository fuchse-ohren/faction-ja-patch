...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			<i class="fa fa-upload"></i> 拡張機能の更新を送信: <s:property value="app.name"/> <s:property value="app.version"/>
	...
	<section class="content">
		<bs:row>
			<bs:mco colsize="6">
				<bs:box type="primary" title="拡張機能を更新">
					<bs:row>
					...
					<div class="form-group" id="appUpload">
						<label>拡張機能の更新を送信</label> <input id="appFile" type="file"
					...
					<div id="extensionPage" class="extensionPage" style="display:none">
						...
						<bs:row>
							...
							<bs:button color="success" size="2" colsize="2" text="更新" id="updateExtension"></bs:button>
						</bs:row>
					</div>
				</bs:box>
			</bs:mco>
