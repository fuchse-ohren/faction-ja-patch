...
<div class="col-md-12">
	...
	<div class="box box-primary">
		<div class="box-header with-border">
			<h3 class="box-title">脆弱性</h3>
		</div>
		<!-- /.box-header -->
		<div class="box-body">
			<button class="btn btn-block btn-info btn-lg" id="addVuln">脆弱性を
				追加</button>
			<br>
			<table id="vulnTable"
		...
		<div class="modal-content">
			<div class="modal-header bg-red">
				...
				<h4 class="modal-title">
					<b><i class="fa fa-bug"></i> 脆弱性入力フォーム</b>
				</h4>
			</div>
					...
					<div class="form-horizontal">
						<div class="box-body">
							<div class="form-group">
								<label for="title" class="col-sm-2 control-label">名称:
									*</label>
								<div class="col-sm-6 control-label">
									<input class="form-control" id="title"
										placeholder="脆弱性の名称" />
								</div>
								<label for="title" class="col-sm-2 control-label">深刻
									度: *</label>
								<div class="col-sm-2">
							...
							<div class="form-group">
								...
								<label for="title" class="col-sm-2 control-label">影響
									度: *</label>
								<div class="col-sm-2">
							...
							<div class="form-group">
								...
								<label for="title" class="col-sm-2 control-label">悪用可能
									度: *</label>
								<div class="col-sm-2">
