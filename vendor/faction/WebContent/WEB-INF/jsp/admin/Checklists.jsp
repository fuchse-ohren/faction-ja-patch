...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="glyphicon glyphicon-wrench"></i> チェックリスト
      <small></small>
    </h1>
  </section>
  ...
  <bs:mco colsize="12">
	  ...
	  <bs:box type="" title="">
	  <bs:row>
	  <bs:button color="success" size="md" colsize="4" text="<span class='fa fa-plus'></span> 新規作成" id="add"></bs:button>
	  </bs:row>
	  <br/>
	  <br/>
	  	<bs:row>
	  
		<bs:select name="編集するチェックリストを選択:" colsize="4" id="list">
		...
		<bs:button color="primary" size="md" colsize="2" text="<span class='fa fa-download'></span> ダウンロード" id="export"></bs:button>
