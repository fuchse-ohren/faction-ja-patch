...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			<i class="fa fa-bug"></i> 脆弱性と評価 <small></small>
		</h1>
	</section>
		...
		<div class="row">
			<bs:mco colsize="6">
				...
				<bs:row>
					<bs:mco colsize="12">
						<bs:box type="warning"
							title="Vulnerability 追跡期間 <span style=font-size:x-small>脆弱性を追跡する日数を入力.</span>">

							<s:iterator value="levels">
								<bs:row>
									<s:set var="levelName" value="getLevelString(riskId)" />
									<bs:inputgroup
										name="${levelName}  - Level ${riskId } 追跡日数:" colsize="6"
										id="due_${riskId}">${daysTillDue }</bs:inputgroup>
									<bs:inputgroup
										name="${levelName }- Level ${riskId } 警告日数:"
							...
							<bs:row>
								...
								<bs:button color="primary" size="md" colsize="6" text="更新"
			...
			<bs:mco colsize="6">
				...
				<bs:row>
					<bs:mco colsize="12">
						<button class="btn btn-danger" id="downloadVulns">すべての脆弱性を
							CSV形式で保存</button>
				...
				<bs:row>
					<bs:mco colsize="12">
						<bs:box type="info"
							title="深刻度設定 <small>深刻度の名称変更</small>">
							<s:iterator value="levels">
								<bs:row>
									<bs:mco colsize="3">
									...
									<bs:button color="info" size="md" colsize="3" text="更新"
