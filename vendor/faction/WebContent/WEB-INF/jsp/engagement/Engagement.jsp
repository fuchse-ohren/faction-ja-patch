...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="glyphicon glyphicon-random"></i>&nbsp;&nbsp;検査計画作成
      <small></small>
    </h1>
  </section>
	...
	<s:if test="back=='assessment'">
		<ol class="breadcrumb">
			<li class="breadcrumb-item">
				<a href="Dashboard">検査ダッシュボード</a>
			</li>
			<li class="breadcrumb-item">
				<a href="Engagement?back=assessment">検査を作成</a>
			</li>
		</ol>
	</s:if>
	</bs:mco>
...
<div class="col-md-12">
 <div class="nav-tabs-custom">
   <ul class="nav nav-tabs">
     ...
     <li><a href="#tab_3" data-toggle="tab">検索</a></li>
     <li><a href="#tab_4" data-toggle="tab">アップロード</a></li>
   </ul>
