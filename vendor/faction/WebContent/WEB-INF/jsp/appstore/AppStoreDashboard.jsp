...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			<i class="fa fa-rocket"></i> 導入済み拡張機能
		</h1>
  <button class="btn btn-success pull-right dashboardButton" id="installExtension"><i class="fa fa-upload"></i>&nbsp;&nbsp;送信</button>
	</section>
	...
	<section class="content">
		<bs:row>
			<bs:mco colsize="6">
				<bs:mco colsize="12">
					<bs:box type="primary" title="<i class='glyphicon glyphicon-th-list'></i>&nbsp;&nbsp;&nbsp;検査拡張機能 <small>ドラッグ操作で処理順を変更可能。上から順に実行されます。</small>">
						<ul id="assessmentExtensions" class="list-group">
						</ul>
					</bs:box>
				</bs:mco>
				<bs:mco colsize="12">
					<bs:box type="primary" title="<i class='fa fa-bug'></i>&nbsp;&nbsp;&nbsp;脆弱性拡張機能 <small>ドラッグ操作で処理順を変更可能。上から順に実行されます。</small>">
						<ul id="vulnerabilityExtensions" class="list-group">
						</ul>
					</bs:box>
				</bs:mco>
				<bs:mco colsize="12">
					<bs:box type="primary" title="<i class='glyphicon glyphicon-ok'></i>&nbsp;&nbsp;&nbsp;検証拡張機能 <small>ドラッグ操作で処理順を変更可能。上から順に実行されます。</small>">
				...
				<bs:mco colsize="12">
					<bs:box type="primary"
						title="<i class='glyphicon glyphicon-search'></i>&nbsp;&nbsp;&nbsp;アプリケーション一覧拡張機能 <small>ドラッグ操作で処理順を変更可能。上から順に実行されます。</small>">
						<ul id="inventoryExtensions" class="list-group">
						</ul>
					</bs:box>
				</bs:mco>
				<bs:mco colsize="12">
					<bs:box type="primary" title="<i class='glyphicon glyphicon-ban-circle'></i>&nbsp;&nbsp;&nbsp;無効化された拡張機能">
			...
			<bs:mco colsize="6">
				<bs:box type="primary" title="説明" id="appLoading">
					<div id="loadingbox" class="extensionDescription js-loading">
					<bs:row>
						<bs:mco colsize="9">
						</bs:mco>
						<bs:mco colsize="3">
  							<button class="btn btn-primary" ><i class="fa fa-upload"></i>&nbsp;&nbsp;送信</button>
  						</bs:mco>
  					</bs:row>
					<bs:row>
				...
				<bs:box type="primary disabled" title="説明" id="appBox">
					<div class="extensionDescription">
					<bs:row>
						<bs:mco colsize="9">
						</bs:mco>
						<bs:mco colsize="3">
  							<button class="btn btn-primary" id="installUpdate"><i class="fa fa-upload"></i>&nbsp;&nbsp;送信</button>
  						</bs:mco>
  					</bs:row>
					<bs:row>
					...
					<bs:row>
						<br/>
						<bs:mco colsize="2">
  							<button class="btn btn-primary" id="saveConfigs"><i class="fa fa-save"></i>&nbsp;&nbsp;保存</button>
  						</bs:mco>
  					</bs:row>
					</div>
