...
<div class="content-wrapper">
  ...
  <section class="content">
	...
	<s:if test="back=='assessment'">
		<ol class="breadcrumb">
			<li class="breadcrumb-item">
				<a href="AssessmentQueue">検査一覧</a>
			</li>
			<li class="breadcrumb-item">
				<a href="Assessment">検査</a>
			</li>
			<li class="breadcrumb-item">
				<a href="">検査計画編集</a>
			</li>
	...
	<s:else>
		<ol class="breadcrumb">
			<li class="breadcrumb-item">
				<a href="Engagement">検査計画</a>
			</li>
			<li class="breadcrumb-item">
				<a href="Engagement#tab_3">検査検索</a>
			</li>
			<li class="breadcrumb-item">
				<a href="">検査計画編集</a>
			</li>
	...
	<div class="col-md-12">
	 <div class="nav-tabs-custom">
	   <ul class="nav nav-tabs">
	     <li class="active"><a href="#tab_1" data-toggle="tab">検査計画</a></li>
	     <li><a href="#tab_2" data-toggle="tab">監査</a></li>
	   </ul>
	   <div class="tab-content">
	     ...
	     <div class="tab-pane" id="tab_2">
	         <bs:datatable columns="日時,説明,利用者" classname="" id="auditlog">
