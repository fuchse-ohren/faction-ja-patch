	...
	<div class="col-md-2">
		<div class="box box-warning">
			<div class="box-header">
				<h3 class="box-title">
					<i class="glyphicon glyphicon-edit"></i> ノート <small>クリックして開く</small>
				</h3>
				<small></small>
				...
				<div class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-4">
							...
							<tr><td><b>作成日時: </b></td><td id="createdBy">
								...
								<s:date name="assessment.notebook[0].created" format="yyyy年MM月dd日 hh:mm:ss"/>
								</td></tr>
							<tr><td><b>Updated: </b></td><td id="updatedBy">
								...
								<s:date name="assessment.notebook[0].updated" format="yyyy年MM月dd日 hh:mm:ss"/>
							</td></tr>
							</table>
						</div>
					</div>
